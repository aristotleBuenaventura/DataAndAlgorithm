...
public class AboutUs extends JFrame  {
	 ...
	 */
	public AboutUs() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(AboutUs.class.getResource("/res/3.png")));
		...
		meet.setFont(new Font("Tahoma", Font.BOLD, 11));
			...
			public void actionPerformed(ActionEvent e) {
				...
				do {
					...
					case 3:
						...
						payroll.setExtendedState(JFrame.NORMAL);
						payroll.setAlwaysOnTop(true);
						payroll.requestFocus();
						payroll.setAlwaysOnTop(false);
