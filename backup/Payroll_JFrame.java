...
public class Payroll_JFrame extends JFrame {
	...
	public Payroll_JFrame() {
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Payroll_JFrame.class.getResource("/res/3MBC Payroll System LOGO.png")));
		setTitle("PayRoll");
		...
		lblField.setBounds(109, 39, 93, 21);
		contentPane.add(lblField);

		JComboBox <String> comboBox_1 = new JComboBox <String>();
		comboBox_1.setBounds(203, 37, 150, 21);
		...
		lblPhilHealth.setBounds(92, 94, 110, 21);
		...
		textFieldPhilHealth.setBounds(203, 91, 150, 20);
		...
		lblWorkingHours.setBounds(353, 40, 178, 21);
		...
		lblTotalDeduction.setBounds(42, 168, 160, 21);
		...
		textFieldTotalDeduction.setBounds(203, 167, 150, 20);
		...
		lblBasicPay.setBounds(92, 67, 110, 21);
		...
		textFieldBasicPay.setBounds(203, 64, 150, 20);
		...
		textFieldPagIbig.setBounds(532, 91, 150, 20);
		...
		lblPagIbig.setBounds(421, 92, 110, 21);
		...
		scrollPane.setBounds(10, 192, 977, 365);
		...
		btnBack.setBounds(922, 167, 65, 21);
