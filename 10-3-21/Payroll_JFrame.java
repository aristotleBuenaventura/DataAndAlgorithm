...
public class Payroll_JFrame extends JFrame {
	...
	public Payroll_JFrame() {
		...
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Payroll_JFrame.class.getResource("/res/Logo Top.png")));
		setTitle("PayRoll");
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(i>=0) {
					...
					b.update(textFieldName.getText(),textFieldID.getText(),comboBox_1.getSelectedItem().toString());
				}else {
					JFrame errorFrame = new JFrame();
					Toolkit.getDefaultToolkit().beep();
					JOptionPane.showMessageDialog(errorFrame, "Please Select a Row First","3MBC Payroll System", JOptionPane.ERROR_MESSAGE);
...
//		contentPane.add(lblSortBy);
		...
		lblSearch.setBounds(824, 15, 73, 21);
		contentPane.add(lblSearch);
		
		textFieldSearch = new JTextField();
		textFieldSearch.setColumns(10);
		textFieldSearch.setBounds(905, 14, 93, 21);
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textFieldSearch.getText().equals("")) {
					JFrame errorFrame = new JFrame();
					Toolkit.getDefaultToolkit().beep();
					JOptionPane.showMessageDialog(errorFrame, "Please Enter the Correct Name","3MBC Payroll System", JOptionPane.ERROR_MESSAGE);
				}else {
		...
		btnSearch.setBounds(905, 40, 89, 23);
