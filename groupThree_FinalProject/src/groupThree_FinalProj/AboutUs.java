	...
	public AboutUs() {
		...
		meet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				graph.addEmployee("Manager","Manager Gracia");
				graph.addEmployee("Main Programmer 1","Lead Programmer Aristotle");			
				graph.addEmployee("Main Programmer 2","Vice Programmer Yunice");
				graph.addEmployee("Sub Programmer","Sub Programmer Jackilou");	
				graph.addEmployee("System Analyst","System Analyst Kathlynne");			

				graph.connectEmp("Manager","Main Programmer 1");
				graph.connectEmp("Manager","System Analyst");
				graph.connectEmp("Main Programmer 1","System Analyst");
				graph.connectEmp("Main Programmer 1","Main Programmer 2");
				graph.connectEmp("Main Programmer 1","Sub Programmer");
