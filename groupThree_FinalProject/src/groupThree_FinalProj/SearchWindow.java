 ...
 * SearchWindow
 * 
 * This class will appear as a window page when the admin user uses 
 * the search bar in the Payroll JFrame to determine whether 
 * the record they are looking for is registered or not.
 * 
 */
