 ...
 * Dashboard
 * 
 * This serves as the homepage of the system.
 * This class contains no data structrue or algorithm topics
 * because it is only used to connect the classes.
 * 
 */
	...
	public Dashboard() {
		...
		lblPayrollText.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//will proceed to Employee Attendance FIRST
